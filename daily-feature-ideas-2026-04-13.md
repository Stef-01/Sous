...
- **Impact on cooks-per-week:** Medium. Reward variability is the single highest-ROI retention lever per the Duolingo/Headspace literature. Users who feel _recognized_ for specific achievements cook the next day at materially higher rates than those who see the same win screen every time.
