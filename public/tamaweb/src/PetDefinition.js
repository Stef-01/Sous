class PetDefinition {
    ...
    prepareSprite(){
        ...
        // Doge: reskin every life stage to a Doberman. The skin overrides only the
        // image (Pet.js:25-27); the spritesheet/animations are unchanged, so growth
        // + all animations keep working. Re-applied on load + ageUp, so saved pets
        // adopt it too. Generated by scripts/gen-doge-atlas.mjs.
        this.spriteSkin = 'resources/img/doge/doge_' + this.getLifeStageLabel() + '.png';
    }
