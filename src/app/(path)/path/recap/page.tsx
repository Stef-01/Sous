          ...
          <>
            ...
            {recap.signatureDishSlug && (
              <button
                ...
                className="flex min-h-11 w-full items-center justify-center gap-1.5 rounded-xl bg-[var(--nourish-green)] px-4 text-[13px] font-semibold text-white transition hover:bg-[var(--nourish-dark-green)] active:scale-[0.97]"
              >
