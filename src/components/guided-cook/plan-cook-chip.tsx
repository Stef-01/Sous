    ...
    return (
      ...
      >
        ...
        <button
          ...
          className="inline-flex min-h-11 min-w-11 items-center justify-center rounded-full px-3 text-[11px] font-medium text-[var(--nourish-subtext)] hover:bg-white/70 hover:text-[var(--nourish-dark)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--nourish-green)]/40"
      ...
      {expanded ? (
        ...
        >
          ...
          <button
            ...
            aria-label="Cancel"
            className="inline-flex h-11 w-11 items-center justify-center rounded-full text-[var(--nourish-subtext)] hover:bg-neutral-100 hover:text-[var(--nourish-dark)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--nourish-green)]/40"
          >
            <X size={16} />
          </button>
        </motion.div>
