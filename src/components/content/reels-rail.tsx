      ...
      <div className="-mx-4 flex snap-x snap-mandatory gap-3 overflow-x-auto px-4 pb-2 scrollbar-hide">
        {reels.map((reel) => (
          <motion.button
            ...
            className="group relative aspect-[9/16] w-[160px] shrink-0 snap-start overflow-hidden rounded-2xl bg-neutral-900 text-left shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--nourish-green)]/40"
