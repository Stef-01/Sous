              ...
              >
                ...
                {status !== "locked" && status !== "completed" && (
                  <button
                    ...
                    className="flex w-full items-center justify-center gap-2 rounded-xl bg-[var(--nourish-green)] py-3.5 text-sm font-semibold text-white transition hover:bg-[var(--nourish-dark-green)] active:scale-[0.97]"
                    type="button"
                  >
                    Start cooking
                    <ArrowRight size={16} />
                ...
                {status === "completed" && (
                  <button
                    onClick={handleStartCook}
                    className="flex w-full items-center justify-center gap-2 rounded-xl border border-neutral-200 py-3 text-sm font-medium text-[var(--nourish-subtext)] transition hover:border-neutral-300 active:scale-[0.97]"
                    type="button"
                  >
                    Practice again
                  </button>
