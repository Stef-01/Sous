...
const SIDE_SUMMARY: Record<string, CookSummary> = {
  ...
  "tu-canh-cu-cai": {
    ...
    cookTimeMinutes: 35,
    ingredientNames: [
      "Pork ribs, cut into 1-2 inch chunks",
      "Fish sauce",
      "Ground black pepper",
      "Shallots, minced",
      "Cooking oil",
  ...
  "tu-goi-ga": {
    ...
    ingredientNames: [
      ...
      "kosher salt (for the quick brine)",
      "fresh ginger, sliced into coins",
      "fish sauce (for the poaching water)",
      "fine salt (for the poaching water)",
      ...
      "coconut water",
      "fresh lemon juice",
      "fish sauce (for the dressing)",
      "ginger, minced",
      "garlic, minced",
      "shallot, minced",
      "fermented chili paste (sambal oelek or tuong ot)",
      "sugar",
    ],
  },
  "tu-ca-tai-chanh": {
    ...
    cookTimeMinutes: 20,
    ingredientNames: [
      "Sushi-grade Kampachi (or other sashimi-grade firm white fish)",
      "Fish sauce",
      "Fresh lemon juice",
      ...
      "Serrano chile, small dice",
      "Kosher salt",
      "Mint leaves",
      "Dill sprigs",
      "Cilantro sprigs",
      "Chives, cut into short lengths",
      "Rice paper rounds, for grilling",
    ],
  },
  "tu-banh-tom": {
    prepTimeMinutes: 30,
    cookTimeMinutes: 25,
    ingredientNames: [
      "U-15 white shrimp, shell-on",
      "sweet potato, cut into thin matchsticks",
      "all-purpose flour",
      "rice flour",
      "large eggs",
      "water",
  ...
  "tu-cha-gio-khoai-mon": {
    ...
    ingredientNames: [
      "ground pork",
      "mung bean (glass) noodles, rehydrated and cut short",
      "carrots, cut into fine matchsticks",
      "fresh taro, peeled and cut into fine matchsticks",
      "oyster sauce",
      "fish sauce",
  ...
  "tu-banh-chuoi-nuong": {
    ...
    cookTimeMinutes: 45,
    ingredientNames: [
      "very ripe lady finger bananas (or Cavendish), sliced 1/2-inch thick",
      "granulated sugar, divided",
      "eggs",
      "sweetened condensed milk",
      "coconut milk",
      "kosher salt",
      "day-old croissants, torn into 1/2-inch chunks",
  ...
  "tu-bac-xiu": {
    ...
    cookTimeMinutes: 7,
    ingredientNames: [
      "Coarse-ground dark roast coffee (Vietnamese-style or a Neapolitan espresso blend)",
  ...
  "tu-rau-muong": {
    ...
    ingredientNames: [
      ...
      "Oyster sauce",
      "Fish sauce (Son brand if you have it)",
      "Kosher salt",
      "Thai chili",
    ],
  },
  "tu-cha-trung-hap": {
    ...
    ingredientNames: [
      ...
      "ground black pepper",
      "cooking oil",
      "banh mi pickles (do chua) and sriracha",
    ],
  },
  "tu-vietnamese-coffee-tiramisu": {
    ...
    ingredientNames: [
      ...
      "Mascarpone",
      "Crème fraîche",
      "Strong Vietnamese phin coffee, cooled",
      "Ladyfingers",
      "Ground cinnamon",
  ...
  "tu-brown-sugar-boba-coffee": {
    ...
    ingredientNames: [
      "Espresso",
      "Caramelized brown-sugar syrup (Tiger syrup)",
      "Heavy cream",
      "Kosher salt",
      "Ready-to-eat crystal boba",
      "Whole milk",
      "Ice",
      "Lemon",
    ],
...
const MEAL_SUMMARY: Record<string, CookSummary> = {
  ...
  "tu-turkey-pho": {
    ...
    cookTimeMinutes: 195,
    ingredientNames: [
      "Leftover roasted turkey carcass (bones, plus any clinging meat)",
      "Filtered water",
      "Yellow onion",
      "Fresh ginger",
      "Garlic cloves",
  ...
  "tu-bun-rieu": {
    ...
    ingredientNames: [
      ...
      "shallots, minced",
      "fermented shrimp paste (mắm tôm or mắm ruốc)",
      "fish sauce",
      "MSG",
      "ground pork",
      "crab paste in soybean oil (Gia Vị Cua)",
      "lump crab meat",
      ...
      "fried puff tofu",
      "dried rice vermicelli (bún)",
      "fresh herbs (perilla/tía tô, mint, cilantro, scallions)",
      "garnishes (bean sprouts, shredded banana blossom, lime wedges, Thai chili)",
    ],
  },
  "tu-banh-canh-gio-heo-tom": {
    ...
    ingredientNames: [
      ...
      "pork knuckle bones",
      "pork shank, cut in large pieces",
      ...
      "fish sauce",
      "kosher salt",
      "Knorr Hạt Nêm seasoning",
      "shrimp, shell-on, deveined",
      "squid, cleaned",
      "mung bean sprouts",
      "culantro, scallion tops, and cilantro, chopped",
      "fried shallots",
      "lime wedges and bird's-eye chilies in fish sauce",
    ],
  },
  "tu-mi-hoanh-thanh": {
    prepTimeMinutes: 45,
    ...
    ingredientNames: [
      "lean ground pork",
      "shrimp (10/20), peeled, deveined, diced small",
      ...
      "chicken stock",
      "dried shrimp",
      "sliced shiitake mushrooms (for broth)",
      "fish sauce (well-aged)",
      "kosher salt",
      "sugar",
      "ground black pepper",
      "fresh kaedama egg noodles",
      "gai lan (Chinese broccoli)",
      "char siu BBQ pork, sliced",
      "fish balls and/or beef balls",
      "scallions, sliced",
      "Chinese red vinegar",
      "chili paste or satay",
    ],
  },
  "tu-bun-bo-hue": {
    prepTimeMinutes: 40,
    ...
    ingredientNames: [
      ...
      "fermented shrimp paste (mam ruoc)",
      "annatto oil",
      "Bun Bo Hue seasoning blend",
      "sa te (Vietnamese lemongrass chili oil)",
      "fish sauce",
      "sugar",
      "thick round Bun Bo Hue rice noodles",
      "garnishes (mung bean sprouts, shredded cabbage, banana blossom, mint, Thai basil, cilantro, scallions, lime wedges)",
    ],
  },
  "tu-mi-xao-gion": {
    prepTimeMinutes: 15,
    ...
    ingredientNames: [
      ...
      "broccoli florets, stalks peeled and sliced",
  ...
  "tu-bun-ga-nuong": {
    ...
    ingredientNames: [
      ...
      "Lemongrass seasoning (or finely minced fresh lemongrass)",
      ...
      "Neutral cooking oil",
      "Fresh mint leaves",
      "Cucumbers, ribboned or speared",
      "Sugar (for pickles)",
      "Kosher salt (for pickles)",
    ],
  },
  "tu-com-suon": {
    prepTimeMinutes: 20,
    ...
    ingredientNames: [
      ...
      "fish sauce, sugar, lime, water and chili for nuoc cham",
    ],
  },
  "tu-char-siu-banh-mi": {
    prepTimeMinutes: 45,
    cookTimeMinutes: 35,
    ingredientNames: [
      "pork steak (Iberico secreto or pork shoulder)",
      ...
      "five-spice or pho seasoning blend",
      "red food coloring",
      ...
      "jalapeno, sliced",
      "large baguette",
      "unsalted butter (for baguette)",
      "garlic, minced (for baguette)",
      "mayonnaise",
      "chicken liver pate",
  ...
  "tu-ga-chien": {
    ...
    cookTimeMinutes: 35,
    ingredientNames: [
      "Bone-in chicken parts (thighs, drumsticks, wings)",
      "Garlic powder",
      "Onion powder",
      "Fresh ginger, minced",
      "Lemongrass, finely minced",
  ...
  "tu-thit-heo-quay": {
    ...
    cookTimeMinutes: 130,
    ingredientNames: [
      "skin-on pork belly, in one slab",
      "kosher salt",
      "organic sugar",
      ...
      "ginger powder",
      "lemongrass, finely minced",
      "pho seasoning blend (star anise, cinnamon, clove, coriander)",
  ...
  "tu-bun-nem-nuong": {
    ...
    ingredientNames: [
      ...
      "Fish sauce (for the pork)",
      "Nem nuong sausage seasoning",
      "Dried vermicelli rice noodles",
      "Carrots, cut into matchsticks",
      "Daikon, cut into matchsticks",
      "Unseasoned rice vinegar (for pickling)",
      "Water (for pickling)",
      "Sugar (for the brine)",
      "Kosher salt (for the brine)",
      "Coconut water",
      "Fresh lemon juice",
      "Fish sauce (for the dipping sauce)",
      "Sugar (for the dipping sauce)",
      "Garlic, minced",
      "Shallot, minced",
      "Thai chili, chopped",
      "Scallions, thinly sliced",
      "High-heat cooking oil (for scallion oil)",
      "Fresh mint",
      "Cucumbers, cut into ribbons or spears",
  ...
  "tu-thit-kho-trung": {
    ...
    cookTimeMinutes: 50,
    ingredientNames: [
      "pork belly, skin off, cut into 1-inch cubes",
      ...
      "neutral cooking oil",
      "minced ginger",
      "coarse Vietnamese black peppercorns, cracked",
      "green onions, sliced",
      "green jalapeño, halved lengthwise",
      "kosher salt (for the blanching water only)",
    ],
  },
  "masoor-dal": {
    prepTimeMinutes: 10,
