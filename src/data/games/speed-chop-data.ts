...
export const speedChopRounds: SpeedChopRound[] = [
  {
    ...
    items: [
      { name: "Tomato", emoji: "🍅", correctSide: "left", funFact: "Botanically a berry!" },
      { name: "Carrot", emoji: "🥕", correctSide: "right" },
      { name: "Avocado", emoji: "🥑", correctSide: "left", funFact: "Actually a large berry" },
      { name: "Broccoli", emoji: "🥦", correctSide: "right" },
      { name: "Pepper", emoji: "🫑", correctSide: "left", funFact: "Peppers are berries" },
      { name: "Celery", emoji: "🥬", correctSide: "right" },
      { name: "Cucumber", emoji: "🥒", correctSide: "left", funFact: "A pepo berry" },
      { name: "Eggplant", emoji: "🍆", correctSide: "left", funFact: "A berry!" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Lentils", emoji: "🫘", correctSide: "left", funFact: "High in both!" },
