...
export function inferMealNutrition(meal: Meal): NutritionProfile {
    ...
    if (text.includes("beef") || text.includes("steak") || text.includes("burger")) tags.push("meat");
    ...
    if (text.includes("pasta") || text.includes("spaghetti") || text.includes("lasagna")) {
        tags.push("pasta");
        category = "carb";
    }
    if (text.includes("noodles") || text.includes("ramen") || text.includes("pad thai")) {
        tags.push("noodles");
        category = "carb";
    }
    ...
    if (text.includes("pizza") || text.includes("sandwich") || text.includes("wrap") || text.includes("burger") || text.includes("taco")) {
        category = "carb";
        tags.push("bread");
    }

    if (text.includes("salad") || text.includes("bowl") || text.includes("vegetable") || text.includes("sabzi")) {
    ...
    if (text.includes("leafy") || text.includes("greens") || text.includes("kale")) tags.push("leafy");
    if (text.includes("curry")) tags.push("curry");
    if (text.includes("fried")) tags.push("fried");
    if (text.includes("yogurt") || text.includes("curd") || text.includes("raita") || text.includes("lassi") || text.includes("tzatziki")) tags.push("yogurt");
    if (text.includes("cheese") || text.includes("paneer") || text.includes("mozzarella")) tags.push("cheese");
