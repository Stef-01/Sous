# NOURISH Meal Pairer — Development Plan

> Design audit and phased roadmap authored through an IDEO design-thinking lens,
> grounded in 2026 web design best practices.

---

## Current State Summary

A single-purpose Next.js 16 app: search a meal, receive three side-dish
suggestions, swap or reroll. Built with Framer Motion, Tailwind 4, Fuse.js.
Strong animation system and accessibility foundation. 30 meals, 60+ sides.
...
| Phase | Item | Status |
|-------|------|--------|
| Phase 1A | Kill idle animations — move delight to hover | ✅ Complete |
| Phase 1B | Surface pairing rationale on cards | ✅ Complete |
| Phase 2A | Fix CTA color (blue → forest green) | ✅ Complete |
| Phase 2B | Serif accent typography (DM Serif Display) | ✅ Complete |
| Phase 2C | Replace "Your Logo" with NOURISH | ✅ Complete |
| Phase 2D | Refine spawn glow ring (shorter, subtler) | ✅ Complete |
| Phase 3A | Remove 3D parallax on hero dish | ✅ Complete |
| Phase 3B | Pool exhaustion feedback | ✅ Complete |
| Phase 3C | Smart shimmer bypass (<100ms skip) | ✅ Complete |
| Phase 3D | Enrich detail modal (swap, hover zoom) | ✅ Complete |
...
ranked pairing system powered by the Python pairing engine. Uses the
**Option A** integration strategy from `documentation.md`: precompute
JSON at build time, consume as static data in the frontend.
...
- `documentation.md` — Architecture and integration contract.
...
*This plan is a living document. Phases are sequential in priority but
individual items within a phase can be parallelized.*
